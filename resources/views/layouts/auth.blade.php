                ...
                <div class="nk-sidebar-element nk-sidebar-head">
                    <div class="nk-sidebar-brand">
                        <a href="html/index.html" class="logo-link nk-sidebar-logo">
                            <img class="logo-light logo-img" src={{ asset('assets/auth/images/logo.png') }} srcset={{ asset('assets/auth/images/logo2x.png') }} alt="logo">
                            <img class="logo-dark logo-img" src={{ asset('assets/auth/images/logo-dark.png') }} srcset={{ asset('assets/auth/images/logo-dark2x.png') }} alt="logo-dark">
                            <img class="logo-small logo-img logo-img-small" src={{ asset('assets/auth/images/logo-small.png') }} srcset={{ asset('assets/auth/images/logo-small2x.png') }} alt="logo-small">
                        </a>
                    </div>
